package com.retoforo.forohub.domain.usuario;
...
public class Usuario implements UserDetails {
    ...
    public Usuario(CrearUsuarioDTO crearUsuarioDTO ) {
        ...
        this.password = new BCryptPasswordEncoder().encode(crearUsuarioDTO.password());
    ...
    public void actualizarUsuarioConPassword(ActualizarUsuarioDTO actualizarUsuarioDTO) {
        if (actualizarUsuarioDTO.password() != null){
            this.password = new BCryptPasswordEncoder().encode(actualizarUsuarioDTO.password());
        }
